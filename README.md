...
> توجه!
> همه رجکس با مرتبه زمانی O(1) اجرا میشوند. هم از این جهت که در رجکس ها تا جای ممکن از + و * و.. استفاده نشده (بیشتر بخوانید) هم از این جهت که شماره تلفن ها طول محدود و تابثی دارند لذا حتی اگر اینجا رجکسی با O(n^3) ارائه میشد، چون n ثابت هست، معادل O(1) محاسبه می شود!
